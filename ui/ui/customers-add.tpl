                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                               <input type="text" class="form-control" name="username" required placeholder="{Lang::T('Enter Account Number')}" 
           value="AC2024{rand(100,999)}" autocomplete="off" onmouseleave="this.type = 'text'" onmouseenter="this.type = 'text'">
				</div> 
                        </div>
                    </div>
                    <div class="form-group">
